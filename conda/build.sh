...
PYTHON_LIBRARY=$PREFIX/lib/libpython${PYTHON_VERSION}${PYTHON_APPENDIX}.so
PYTHON_INCLUDE_DIR=$PREFIX/include/python${PYTHON_VERSION}${PYTHON_APPENDIX}

BOOST_LIBRARY=$PREFIX/lib/libboost_python.so
ODLPP_BUILDDIR=$SRC_DIR/build-py$PYTHON_VERSION
...
ODLPP_CC_BUILDOPTS="-DCMAKE_CXX_COMPILER=$PREFIX/bin/c++ -DCMAKE_C_COMPILER=$PREFIX/bin/cc"
...
ODLPP_CMAKE_COMMAND='cmake $ODLPP_CMAKEOPTS $SRC_DIR'
